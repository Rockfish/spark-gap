...
use spark_gap::camera_handler::CAMERA_BIND_GROUP_LAYOUT;
    ...
    pub fn render(&self, context: &Context, world: &World) {
...

        {
            ...
            context.queue.write_buffer(
                &model.model_transform_buffer, 0, bytemuck::cast_slice(&model_transform.to_cols_array()));

            context.queue.write_buffer(
                &model.final_bones_matrices_buffer, 0, bytemuck::cast_slice(final_bones.as_ref()));
